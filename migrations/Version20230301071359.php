 ...
 */
final class Version20230301071359 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE invoice (id INT NOT NULL, customer_id INT NOT NULL, amout DOUBLE PRECISION NOT NULL, sent_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, status VARCHAR(255) NOT NULL, chrono INT NOT NULL, PRIMARY KEY(id))');
